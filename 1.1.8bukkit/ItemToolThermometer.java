...
public class ItemToolThermometer extends Item implements ITextureProvider
{
    ...
    public void messagePlayer(EntityHuman var1, TileEntity var2)
    {
        ...
        switch (ItemToolThermometer.NamelessClass789257365.$SwitchMap$net.minecraft.server$nuclearcontrol$ThermometerVersion[this.thermometerVersion.ordinal()])
        {
            case 1:
    ...
    static class NamelessClass789257365
    {
