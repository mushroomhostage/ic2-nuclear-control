...
public class ItemToolThermometer extends Item implements ITextureProvider
{
    ...
    public void messagePlayer(EntityHuman var1, TileEntity var2)
    {
        ...
        switch (ItemToolThermometer.NamelessClass722467806.$SwitchMap$net$minecraft$src$nuclearcontrol$ThermometerVersion[this.thermometerVersion.ordinal()])
        {
            case 1:
    ...
    static class NamelessClass722467806
    {
