...
public class ItemToolThermometer extends Item implements ITextureProvider
{
    ...
    public void messagePlayer(EntityHuman var1, IReactor var2)
    {
        ...
        switch (ItemToolThermometer.NamelessClass309266745.$SwitchMap$net.minecraft.server$nuclearcontrol$ThermometerVersion[this.thermometerVersion.ordinal()])
        {
            case 1:
    ...
    static class NamelessClass309266745
    {
